...
function product_signature() {
	if(function_exists('logged_user') && (logged_user() instanceof Contact) && logged_user()->isMemberOfOwnerCompany()) {
		$result = lang('footer powered', 'http://www.facebook.com/lilprogramer', clean(product_name()) . ' ' . product_version());
		if(Env::isDebugging()) {
			ob_start();
		...
		return  lang('footer powered', 'http://www.facebook.com/lilprogramer', clean(product_name()));
	} // if
} // product_signature
